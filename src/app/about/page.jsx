    ...
    <div className="bg-gradient-to-b from-gray-900 via-black to-gray-900 text-gray-100 min-h-screen">
      <section className="text-center py-20 px-6">
        ...
        <p className="mt-6 text-lg max-w-2xl mx-auto text-gray-300">
          Welcome to
          <span className="font-semibold text-pink-400"> Sound Bar</span>, a
          platform built to connect music lovers with the sounds and stories
          that inspire them.
        </p>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 py-12">
        ...
        <p className="text-lg leading-relaxed text-gray-300 text-center">
          ...
          <span className="text-purple-400">celebrate music</span>, empower
          artists, and create a community where creativity thrives. We believe
          that music is more than just sound — it’s{" "}
          <span className="italic text-pink-400">
            emotion, connection, and culture.
          </span>
        </p>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6 grid gap-10 md:grid-cols-3">
          <div className="p-6 rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 shadow-lg hover:shadow-pink-500/30 transition">
            ...
            <p className="text-gray-300">
              We live and breathe music, dedicating ourselves to bringing the
              best experiences to fans worldwide.
            </p>
          </div>
          <div className="p-6 rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 shadow-lg hover:shadow-purple-500/30 transition">
            ...
            <p className="text-gray-300">
              Our platform is built for connection, bringing together artists,
              listeners, and creators from every corner.
            </p>
          </div>
          <div className="p-6 rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 shadow-lg hover:shadow-indigo-500/30 transition">
            ...
            <p className="text-gray-300">
              We’re constantly evolving, exploring new ways to experience and
      ...
      <section className="text-center py-16 px-6">
        ...
        <p className="text-gray-400 max-w-2xl mx-auto mb-8">
          Whether you’re a fan, an artist, or just someone who loves the rhythm
          of life,
